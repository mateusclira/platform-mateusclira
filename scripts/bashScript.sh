...
RESOURCE_GROUP_NAME=mateusclira-infra
STORAGE_ACCOUNT_NAME=mateuscliratstate
...
az keyvault create --name "mateusclirakv" --resource-group "mateusclira-infra" --location uksouth
az keyvault secret set --vault-name "mateusclirakv" --name "tstateaccess" --value {$ACCOUNT_KEY}
az keyvault secret show --vault-name "mateusclirakv" --name "tstateaccess"